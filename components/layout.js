...
const name = 'Sheng Tse Tsai';
export const siteTitle = "ST's website";
        ...
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                {home ? (
                    ...
                    <>
                        <Link href="/">
                            <Image priority src="/images/1605400218854.jpg" className={utilStyles.borderCircle} height={300} width={300} alt="" />
                        </Link>
